# RSS2 or Atom Feed to JSON Webtask
Transforms an RSS2/Atom Feed to JSON given a querystring parameter `url`.
...
```
wt create --name optional-name-for-your-webtask https://raw.githubusercontent.com/francolaiuppa/webtasks/master/feed-to-json/index.js
```
